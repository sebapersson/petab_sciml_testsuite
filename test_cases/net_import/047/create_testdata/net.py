...
class Net(nn.Module):
    def __init__(self) -> None:
        super().__init__()
        self.norm1 = nn.InstanceNorm2d(3, affine=True)
        self.norm2 = nn.InstanceNorm2d(4)
        self.layer1 = nn.Conv2d(3, 4, 5)
        self.layer2 = nn.Conv2d(4, 1, 5)
...
dir_save = os.path.join(os.getcwd(), 'test_cases', 'net_import', "047")
net = Net()
