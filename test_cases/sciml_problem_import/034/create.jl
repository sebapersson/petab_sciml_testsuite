...
petab_parameters_ids = [
    :alpha, :delta, :beta, :net1_input_pre1, :net1_input_pre2, :net1_layer1_weight_prior,
]
...
parameters_df = CSV.read(
    joinpath(@__DIR__, "petab", "parameters.tsv"), DataFrame;
    stringtype = String
)
