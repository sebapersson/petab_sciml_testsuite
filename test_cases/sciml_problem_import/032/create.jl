...
parameters_df[!, :priorDistribution] = ["uniform", "uniform", "uniform", missing, missing, "normal"]
parameters_df[!, :priorParameters] = ["0.0;15.0", "0.0;15.0", "0.0;15.0", missing, missing, "0.0;1.0"]
