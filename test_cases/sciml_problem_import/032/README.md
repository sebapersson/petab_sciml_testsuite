...
except `layer1` which has a `Normal(0.0, 2.0)` prior.
...
The inputs to the network are provided by the `input1` and `input2` parameters from the parameters table. All parameters in the NN-model have a `Normal(0.0, 1.0)` prior.
